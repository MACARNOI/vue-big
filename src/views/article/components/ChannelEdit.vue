...
const rules = {
  ...
  cate_alias: [
    ...
    { pattern: /^[a-zA-Z0-9]{1,15}$/,
      message: '分类名必须是 1-15 位的字母或数字', trigger: 'blur' }
  ]
}
...
<template>
  ...
  >
    <el-form ref="formRef" :model="formModel" :rules="rules">
      <el-form-item label="分类名称" label-width="100px" prop="cate_name"
      style="padding-right: 30px">
        <el-input v-model="formModel.cate_name"
        placeholder="请输入分类名称"></el-input>
      </el-form-item>
      <el-form-item label="分类别名" label-width="100px" prop="cate_alias"
      style="padding-right: 30px">
